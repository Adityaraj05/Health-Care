...
export default function De_4() {
  ...
  const text=" First Aid Solution Seek medical attention: If you suspect that you have cholera, seek medical attention immediately. :Cholera is a serious illness that requires prompt treatment. :Rehydrate: Drink plenty of fluids such as water, herbal teas, or oral rehydration solution (ORS) to prevent dehydration. :ORS is a solution of salt, sugar, and water that is available at pharmacies and can help replace lost fluids and electrolytes. :Avoid solid foods: Avoid solid foods until your symptoms improve. :Stick to clear liquids such as broth, coconut water, or weak tea. :Use antibiotics: Your doctor may prescribe antibiotics to treat the cholera infection. :Follow the dosage instructions carefully and complete the entire course of medication. :Rest: Get plenty of rest to allow your body to recover from the infection.";
  ...
  <iframe src="https://www.youtube.com/embed/ZxtM2WIeW70" title="YouTube video player"  allowfullscreen></iframe>
</div>
</div>
  </div>
  </div>
